...
//         console.log(response.data.message); // Log the message array to inspect it
...
//                     Created on: {new Date(category.CREATED_TIME).toLocaleDateString()} <br />
//                     Last updated: {new Date(category.LAST_UPD_TIME).toLocaleDateString()}
//                   </Card.Text>
//                 </Card.Body>
//               </Card>
//             </Col>
...
//     try {
//       const response = await axios.post('https://lubosoftdev.com/api/nst_back_end_code/catagory.php?run=insert_main_catagory', {
//         deviceType: 'web',
//         username: 'anvar',
...
//     try {
//       const response = await axios.post('https://lubosoftdev.com/api/nst_back_end_code/catagory.php?run=update_main_catagory', {
//         deviceType: 'web',
//         username: 'anvar',
...
//         if (response.data.success) {
//           // Option 1: Remove the category from the local state
//           setCategories(
